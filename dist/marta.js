...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (this && this.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (_) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar moment_timezone_1 = __importDefault(__webpack_require__(/*! moment-timezone */ \"moment-timezone\"));\nvar axios_1 = __importDefault(__webpack_require__(/*! axios */ \"./node_modules/axios/index.js\"));\nvar utils_1 = __webpack_require__(/*! ./utils */ \"./src/utils.ts\");\nvar REALTIME_RAIL_ENDPOINT = 'http://developer.itsmarta.com/RealtimeTrain/RestServiceNextTrain/GetRealtimeArrivals';\nvar RealtimeRailApi = /** @class */ (function () {\n    function RealtimeRailApi(apiKey) {\n        if (apiKey == null || apiKey.length === 0) {\n            throw new Error('An API Key is required to use the realtime rail endpoint');\n        }\n        this.apiKey = apiKey;\n    }\n    RealtimeRailApi.prototype.getArrivals = function (callback) {\n        return __awaiter(this, void 0, void 0, function () {\n            var _this = this;\n            return __generator(this, function (_a) {\n                return [2 /*return*/, utils_1.applyCallback(callback, function () { return __awaiter(_this, void 0, void 0, function () {\n                        var res;\n                        var _this = this;\n                        return __generator(this, function (_a) {\n                            switch (_a.label) {\n                                case 0: return [4 /*yield*/, this.request(REALTIME_RAIL_ENDPOINT)];\n                                case 1:\n                                    res = _a.sent();\n                                    return [2 /*return*/, res.map(function (r) { return _this.convertResponse(r); })];\n                            }\n                        });\n                    }); })];\n            });\n        });\n    };\n    RealtimeRailApi.prototype.getArrivalsForStation = function (station, callback) {\n        return __awaiter(this, void 0, void 0, function () {\n            var _this = this;\n            return __generator(this, function (_a) {\n                return [2 /*return*/, utils_1.applyCallback(callback, function () { return __awaiter(_this, void 0, void 0, function () {\n                        var allArrivals;\n                        return __generator(this, function (_a) {\n                            switch (_a.label) {\n                                case 0: return [4 /*yield*/, this.getArrivals()];\n                                case 1:\n                                    allArrivals = _a.sent();\n                                    return [2 /*return*/, allArrivals.filter(function (a) { return a.station === station; })];\n                            }\n                        });\n                    }); })];\n            });\n        });\n    };\n    RealtimeRailApi.prototype.request = function (url) {\n        return __awaiter(this, void 0, void 0, function () {\n            var res;\n            return __generator(this, function (_a) {\n                switch (_a.label) {\n                    case 0: return [4 /*yield*/, axios_1.default.get(url, { params: { apikey: this.apiKey } })];\n                    case 1:\n                        res = _a.sent();\n                        return [2 /*return*/, res.data];\n                }\n            });\n        });\n    };\n    RealtimeRailApi.prototype.convertRailDirection = function (apiDirection) {\n        switch (apiDirection) {\n            case 'N': return 'North';\n            case 'S': return 'South';\n            case 'E': return 'East';\n            case 'W': return 'West';\n        }\n    };\n    RealtimeRailApi.prototype.convertResponse = function (res) {\n        var waitingTimeSeconds = parseInt(res.WAITING_SECONDS, 10);\n        return {\n            destination: res.DESTINATION,\n            direction: this.convertRailDirection(res.DIRECTION),\n            eventTime: utils_1.convertApiDateTimeFormat(res.EVENT_TIME),\n            line: res.LINE,\n            nextArrival: utils_1.convertNextArrivalTime(res.NEXT_ARR),\n            station: res.STATION,\n            trainId: res.TRAIN_ID,\n            waitingTimeSeconds: waitingTimeSeconds,\n            waitingTime: moment_timezone_1.default.duration(waitingTimeSeconds, 'seconds'),\n            waitingState: res.WAITING_TIME\n        };\n    };\n    return RealtimeRailApi;\n}());\nexports.RealtimeRailApi = RealtimeRailApi;\n\n\n//# sourceURL=webpack:///./src/RealtimeRailApi.ts?");
...
"use strict";
eval("\nfunction __export(m) {\n    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];\n}\nObject.defineProperty(exports, \"__esModule\", { value: true });\n__export(__webpack_require__(/*! ./RealtimeRailApi */ \"./src/RealtimeRailApi.ts\"));\n__export(__webpack_require__(/*! ./RealtimeBusApi */ \"./src/RealtimeBusApi.ts\"));\n\n\n//# sourceURL=webpack:///./src/index.ts?");
